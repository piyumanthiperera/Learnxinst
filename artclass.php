...
<html lang="en">
   ...
   <body>
      ...
      <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital"><span style="color: #fcce2d">Art</span> <pre>කලා</pre></h1>
			
            <div class="services_section_2" align="center">
              <p style="font-size: 30px;"> අනාගතය ජයගැනීමට වෙරදරන ඔබ වෙනුවෙන් නව පංති අාරමිභය...</p> 
                  <div class="col-md-6">
                     <div class="image_main">
                        <img src="images/art-1.png" class="image_8" style="width:80%;">
                        <div class="text_main">
                  ...
                  <div class="col-md-6">
                     <div class="image_main">
                        <img src="images/art-2.png" class="image_8" style="width:80%;">
                        <div class="text_main">
                  ...
                  <div class="col-md-6">
                     <div class="image_main">
                        <img src="images/art-3.png" class="image_8" style="width:80%">
                        <div class="text_main">
                           <div class="seemore_text">
						   </div>
                        </div>
