...
<!-- services section start -->
      <div class="services_section layout_padding">
         <div class="container">
            ...
            <h1 class="services_taital"><span style="color: #fcce2d">Science</span> <pre>විද්‍යා</pre></h1>
            <div class="services_section_2">
			<p style="font-size: 30px;"> අනාගතය ජයගැනීමට වෙරදරන ඔබ වෙනුවෙන් නව පංති අාරමිභය...</p> 
               <div class="row">
                  <div class="col-md-6">
                     <div class="image_main">
                        <img src="images/sci-1.png" class="image_8" style="width:100%">
                        <div class="text_main">
                  ...
                  <div class="col-md-6">
                     <div class="image_main">
                        <img src="images/sci-2.png" class="image_8" style="width:100%;">
                        <div class="text_main">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="image_main">
                        <img src="images/sci-3.png" class="image_8" style="width:100%">
                        <div class="text_main">
                  ...
                  <div class="col-md-6">
                     <div class="image_main">
                        <img src="images/sci-4.png" class="image_8" style="width:100%">
                        <div class="text_main">
